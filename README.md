...
check_token() {
  ...
  if [ "$USER_TOKEN" = "qin" ]; then
    ...
    echo -e "${YELLOW}TELEGRAM : @qin${NC}"
    echo -e "${YELLOW}WHATSAPP : 6283139764917${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 25K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©qin24${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${BLUE}'ggg      ,gg'''  .    ggg       Auto Installer qin Private   ${NC}"
  echo -e "${BLUE}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${BLUE}ggg:     gg.     -   ,ggg       • Telegram : -     ${NC}"
  echo -e "${BLUE} ggg:     ggg._    _,ggg        • Creadit  : qin ${NC}"
  echo -e "${BLUE} ggg.    '.'''ggggggp           • Support by qin  ${EvichacEvich"${BLUE}  'ggg    '-.__                                           ${NC}"
  echo -e "${BLUE}    ggg                                                   ${NC}"
  echo -e "${BLUE}      ggg                                                 ${NC}"
  echo -e "${BLUE}        ggg.                                              ${NC}"
  echo -e "${BLUE}          ggg.                                            ${NC}"
